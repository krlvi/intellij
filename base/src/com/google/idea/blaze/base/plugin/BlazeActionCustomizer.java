...
public class BlazeActionCustomizer implements ActionConfigurationCustomizer {
    ...
    public void customize(@NotNull ActionManager actionManager) {
        ...
        ReplaceActionHelper.conditionallyHideAction(actionManager, "CompileDirty", Blaze::isBlazeProject);

        // 'Build' > 'Make Modules' action
        ReplaceActionHelper.conditionallyHideAction(actionManager,
        ...
        ReplaceActionHelper.conditionallyHideAction(actionManager, IdeActions.ACTION_COMPILE, Blaze::isBlazeProject);
    }
}
